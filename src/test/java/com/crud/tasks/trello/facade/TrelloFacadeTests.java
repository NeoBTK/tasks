...
public class TrelloFacadeTests {
    ...
    void testCreateCard() {
        // Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("card1", "description1", "pos", "1");
        TrelloCard trelloCard = new TrelloCard("card1", "description1", "pos", "1");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "card1", "url.com");
        ...
        // When
        CreatedTrelloCardDto expectedCreatedTrelloCardDto = trelloFacade.createCard(trelloCardDto);

        // Then
        assertEquals("card1", expectedCreatedTrelloCardDto.getName());
    }
}
